...
class Lenkeliste<T> implements Liste<T>{
  ...
  // Lager en klasse node for å holde styr på liseobjekter og rekkefølge.
  ...
  // Her legges et element inn i lista på en gitt posisjon.
  ...
  public void leggTil(int pos, T x) throws UgyldigListeIndeks{
    ...
    // Sjekker om posisjon eller storrelsen på lista er på null eller om
    ...
    // Her legges elemtentet helt først i lista.
    else if (pos == 0){
  ...
  // Overrider metode fra grensesnittet.
  // Her legges et element på slutten av listen, altsaa sistenoden blir
  ...
  // Her blir data til et element på en gitt posisjon
  // byttet med en annen gitt data.
  // denne metoden kan også faa en feilmelding.
  ...
  public T fjern(int pos) throws UgyldigListeIndeks{
    ...
    // Hvis posisjon er 0, kaller vi på fjern metoden som fjerner det forste
    // elemtnet i lista.
    else if (pos == 0){
      return this.fjern();
      }

      // Maa passe på at hvis posisjonen er det siste elementet i lista
